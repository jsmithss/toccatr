...
`filtered_df <- df %>% filter(platename == first_plate) # Select rows with the same plate`
...
(v0.9) Add clipfromxl to functions\
(v1.0) Work out if tubemap list can be added to a function
