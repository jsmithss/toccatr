...
* `prismy_time()` Reformat timecourse data for Prism grouped tables  
...
* `loggy()` Log transform all numeric variables with adjustment for values below 1  
* `anony()` Recode a variable with an anonymised name    
...
* `theme_tt2()` Clean ggplot theme using Fira Sans font  
* `theme_tt2f()` Clean ggplot theme using Fira Sans font, for faceted data  
