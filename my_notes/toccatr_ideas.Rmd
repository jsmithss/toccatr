...
Include stopifnot() for plate loading, platemap, hotplate
https://waterdata.usgs.gov/blog/rds-assertions/

Add in anonny to anonymise a variable with either pokemon names or random words
